...
\addtobeamertemplate{footline}{\raisebox{-1.3pt}{\href{https://fmin.xyz}{\includegraphics[width=1cm]{logo.pdf}}} \hspace{0.2cm} \hbox{\insertsection \hspace{0.2cm}} \hfill \href{https://github.com/MerkulovDaniil/mipt24/blob/main/lectures/optml.md}{\faGithub} \hspace{0.07cm} \href{https://t.me/fminxyz}{\faTelegram} \hspace{0.4cm}\hbox{\insertframenumber \hspace{0.1cm}}
  \vskip0pt
}
      ...
      \begin{tikzpicture}[remember picture,overlay]
        ...
        \node[fill=white, fill opacity=0.7, text opacity=1, inner sep=10pt, rounded corners=10pt] at (current page.center) {
          \begin{minipage}{0.5\paperwidth}
            ...
            \vspace*{0.2cm}
            \usebeamerfont{date} 30 ноября 2024
          \end{minipage}
        };
      \end{tikzpicture}
    }
