...
1.  Достаточное условие существования проекции точки на множество.
    ...
    Замечание: для бесконечномерного гильбертова пространства это уже может быть неверно: рассмотрим $K = \left\{ \left(1 + \frac{1}{n} \right) \mathbf{e}_n \,\middle|\, n \in \mathbb{N} \right\}$, оно замкнуто в $l_2$, расстояние от 0 до $K$ равно 1, но нет точки из $K$, на которой оно бы достигалось.
    :::
1.  Достаточное условие единственности проекции точки на множество.
    ...
    Замечание: а вот это условие уже верно в произвольном гильбертовом пространстве: это Теорема Рисса о проекции точки на выпуклое замкнутое множество гильбертова пространства из курса функционального анализа.
    :::
